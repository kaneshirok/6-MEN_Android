...
import com.src.novel.todokeru.databinding.FragmentFavoriteRowBinding;
...
public class FavoriteAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        FragmentFavoriteRowBinding binding;

        if (convertView == null) {
            binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.fragment_favorite_row, null, false);
            convertView = binding.getRoot();
            convertView.setTag(binding);
        } else {
            binding = (FragmentFavoriteRowBinding) convertView.getTag();
        }
